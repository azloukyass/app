        ...
        <header className="sticky top-0 z-40 bg-black border-b border-red-600/30" data-testid="site-header">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-10 text-xs text-white">
                    ...
                    <div className="flex items-center gap-5 font-medium">
                        ...
                        <div className="flex items-center gap-3 pl-2 border-l border-white/15">
                            ...
                            <a href="https://www.tiktok.com/@bennouri_piece_auto?_r=1&_t=ZS-977PCfpZzRS" target="_blank" rel="noopener noreferrer" className="text-white hover:text-red-500" aria-label="TikTok"><TikTokIcon className="w-4 h-4" /></a>
            ...
            <div className="bg-black">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-6">
                    ...
                    {/* Account & cart */}
                    <div className="flex items-center gap-3 sm:gap-6 lg:gap-7 flex-shrink-0 ml-auto">
                        {user ? (
            ...
            <div className="md:hidden bg-black border-t border-white/10 px-4 py-2">
                <form onSubmit={submitSearch} className="flex bg-white rounded-sm overflow-hidden shadow-sm">
                    <input
                        type="text"
                        value={q}
                        onChange={(e) => setQ(e.target.value)}
                    ...
                    <button
                        type="submit"
                        className="bg-red-600 hover:bg-red-700 px-4 flex items-center justify-center transition-colors"
                    >
